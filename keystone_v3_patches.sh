...
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/85/178385/20 && git cherry-pick FETCH_HEAD
echo "Applying support for keystone v3 api - the domain resource"
# support for keystone v3 api - the domain resource
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/39/174439/32 && git cherry-pick FETCH_HEAD
echo "Applying support for keystone v3 api - the project resource"
# support for keystone v3 api - the project resource
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/68/174468/29 && git cherry-pick FETCH_HEAD
echo "Applying support for keystone v3 api - the user resource"
# support for keystone v3 api - the user resource
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/76/174976/25 && git cherry-pick FETCH_HEAD
echo "Applying support for keystone v3 api - the user_role resource"
# support for keystone v3 api - the user_role resource
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/99/174999/25 && git cherry-pick FETCH_HEAD
...
git fetch https://ichavero@review.openstack.org/openstack/puppet-keystone refs/changes/60/175060/30 && git cherry-pick FETCH_HEAD
